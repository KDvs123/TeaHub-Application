        ...
        child: Column(
          ...
          children: [
                  ...
                  Positioned(
                    ...
                    child: Align(
                      child: SizedBox(
                        ...
                        height: 263*fem,
                        child: Image.asset(
                          'assets/user_profile/images/rectangle-51.png',
                          width: 390*fem,
                          height: 263*fem,
                        ),
                      ),
                  ...
                  Positioned(
                    ...
                    child: Align(
                      child: SizedBox(
                        ...
                        height: 24*fem,
                        child: Image.asset(
                          'assets/user_profile/images/top.png',
                          width: 350*fem,
                          height: 24*fem,
                        ),
                      ),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            // avatartEB (226:2651)
                            margin: EdgeInsets.fromLTRB(47.5*fem, 0*fem, 46.5*fem, 0*fem),
                            width: double.infinity,
                            height: 130*fem,
                            child: Stack(
                              children: [
                                Positioned(
                                  ...
                                  child: Align(
                                    child: SizedBox(
                                      ...
                                      height: 120*fem,
                                      child: Image.asset(
                                        'assets/user_profile/images/rectangle-6.png',
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ),
                                ...
                                Positioned(
                                  ...
                                  child: Align(
                                    child: SizedBox(
                                      ...
                                      height: 46*fem,
                                      child: Image.asset(
                                        'assets/user_profile/images/group-62.png',
                                        width: 46*fem,
                                        height: 46*fem,
                                      ),
                                    ),
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(20*fem, 45*fem, 9*fem, 10*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(16*fem, 14*fem, 24*fem, 11*fem),
                    width: 342*fem,
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 117*fem, 0*fem),
                          width: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                ...
                                height: 24*fem,
                                child: Image.asset(
                                  'assets/user_profile/images/line-business-profile-line.png',
                                  width: 24*fem,
                                  height: 24*fem,
                                ),
                              ),
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                height: 24*fem,
                                child: Image.asset(
                                  'assets/user_profile/images/line-media-notification-3-line.png',
                                  width: 24*fem,
                                  height: 24*fem,
                                ),
                              ),
                        ...
                        Container(
                          ...
                          padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 212*fem, 0*fem),
                          width: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                ...
                                height: 24*fem,
                                child: Image.asset(
                                  'assets/user_profile/images/auto-group-oclv.png',
                                  width: 24*fem,
                                  height: 24*fem,
                                ),
                              ),
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 11*fem),
                          padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 167*fem, 0*fem),
                          width: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                ...
                                height: 24*fem,
                                child: Image.asset(
                                  'assets/user_profile/images/line-user-contacts-line.png',
                                  width: 24*fem,
                                  height: 24*fem,
                                ),
                              ),
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                height: 24*fem,
                                child: Image.asset(
                                  'assets/user_profile/images/line-communication-chat-quote-line.png',
                                  width: 24*fem,
                                  height: 24*fem,
                                ),
                              ),
                        ...
                        Container(
                          ...
                          padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 176*fem, 0*fem),
                          width: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                ...
                                height: 24*fem,
                                child: Image.asset(
                                  'assets/user_profile/images/line-system-lock-2-line.png',
                                  width: 24*fem,
                                  height: 24*fem,
                                ),
                              ),
                  ...
                  Positioned(
                    ...
                    child: Align(
                      child: SizedBox(
                        ...
                        height: 64*fem,
                        child: Image.asset(
                          'assets/user_profile/images/float-btn-5hq.png',
                          width: 64*fem,
                          height: 64*fem,
                        ),
                      ),
                  ...
                  Positioned(
                    ...
                    child: Align(
                      child: SizedBox(
                        ...
                        height: 75*fem,
                        child: Image.asset(
                          'assets/user_profile/images/bg-ysV.png',
                          width: 375*fem,
                          height: 75*fem,
                        ),
                      ),
                  ...
                  Positioned(
                    ...
                    child: Align(
                      child: SizedBox(
                        ...
                        height: 40*fem,
                        child: Image.asset(
                          'assets/user_profile/images/scansvgrepocom-N6T.png',
                          width: 40*fem,
                          height: 40*fem,
                        ),
                      ),
