              ...
              children: [
                Container(
                  ...
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(100),
                    child: Image.asset(
                      "images/snap_tips imgs/image 1.jpg",
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
            ...
            Row(
              ...
              children: [
                _buildImageWithBorderAndIcon(
                    "images/snap_tips imgs/image 2.jpg",
                    Colors.red,
                    "Too close"),
                SizedBox(width: 30), // Increase the spacer between images
                _buildImageWithBorderAndIcon(
                    "images/snap_tips imgs/image 3.jpg", Colors.red, "Too far"),
                SizedBox(width: 30), // Increase the spacer between images
                _buildImageWithBorderAndIcon(
                    "images/snap_tips imgs/image 4.jpg",
                    Colors.red,
                    "Multiple species"),
              ],
            ),
